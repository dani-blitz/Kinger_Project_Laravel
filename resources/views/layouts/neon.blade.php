...
<head>
    ...
    <title>@yield('title') | NEON SCHOOL</title>
    <style>
        ...
        * {
        ...
        body::after {
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at 20% 40%, rgba(157, 0, 255, 0.1) 0%, transparent 50%),
...
<div class="container">
    ...
    @if(session('error'))
        <div style="background: rgba(255, 0, 100, 0.2); border-left: 4px solid #ff0066; padding: 15px; margin-bottom: 20px; color: #ff66cc;">
            ⚠️ {{ session('error') }} ⚠️
        </div>
    @endif
